...
class Gpt4All(Dataset):
    def __init__(self, mode: str, cache_dir: str = None) -> None:
        ...
        dataset = load_dataset(
            'json',
            data_files="/mnt/petrelfs/chenqin.p/dyh/Open-Assistant/data/cache_dataset/gpt4all/data_singleround_pruned_3.jsonl"
        )
        ...
        dataset_multi = load_dataset(
            'json',
            data_files="/mnt/petrelfs/chenqin.p/dyh/Open-Assistant/data/cache_dataset/gpt4all/data_multiround_pruned_3.jsonl"
        )
