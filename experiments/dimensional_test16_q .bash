...
for ((i=0; i<${#list1[@]}; i++)); do
    ...
    --peft_path "/cpfs01/user/chenqin.p/dyh/MOELoRA-peft/saved/moelora/16experts_dimensional_q_4_13/checkpoint-${item2}" \
    --prediction_output_path "/cpfs01/user/chenqin.p/dyh/MOELoRA-peft/eval/llama/16expert/epoch${item1}_4_13" \
