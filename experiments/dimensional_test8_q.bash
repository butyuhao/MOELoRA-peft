...
for ((i=0; i<${#list1[@]}; i++)); do
    ...
    --peft_path "/cpfs01/user/chenqin.p/dyh/MOELoRA-peft/saved/moelora/8experts_dimensional_q_4_21_balancing_CE/checkpoint-${item2}" \
    --prediction_output_path "/cpfs01/user/chenqin.p/dyh/MOELoRA-peft/eval/llama/8expert/epoch${item1}_4_21_balancing" \
